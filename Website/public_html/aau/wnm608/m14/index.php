   ...
   <div class="css-slider-wrapper">
      ...
      <div class="lslider lslide-1">
        ...
        <div class="lslider-content">
          ...
          <h2>Coconut Lime</h2>
          <a href="http://go-roxy.com/aau/wnm608/m14/sp.php?id=1">
          <button type="button" class="buy-now-btn" name="button">$5</button></a>
          <br>
          <br>
          <a href="http://go-roxy.com/aau/wnm608/m14/main.php">
      ...
      <div class="lslider lslide-2">
        ...
        <div class="lslider-content">
          <h4>New Product</h4>
          <h2>Hazelnut</h2>
          <a href="http://go-roxy.com/aau/wnm608/m14/sp.php?id=13">
      ...
      <div class="lslider lslide-3">
        ...
        <div class="lslider-content">
          <h4>Best Seller</h4>
          <h2>Lavender</h2>
         <a href="http://go-roxy.com/aau/wnm608/m14/sp.php?id=2">
          <button type="button" class="buy-now-btn" name="button">$5</button></a>
          <br>
          <br>
          <a href="http://go-roxy.com/aau/wnm608/m14/main.php">
      ...
      <div class="lslider lslide-4">
        ...
        <div class="lslider-content">
          <h4>Fruit</h4>
          <h2>Strawberries</h2>
        <a href="http://go-roxy.com/aau/wnm608/m14/sp.php?id=10">
          <button type="button" class="buy-now-btn" name="button">$5</button></a>
          <br>
          <br>
           <a href="http://go-roxy.com/aau/wnm608/m14/main.php">
