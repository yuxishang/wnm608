...
$empty_product = (object)[
	...
	"image_main"=>"/images/store/fruit_durian_m.jpg",
	"other_images"=>"/images/store/fruit_durian.jpg"
];
...
<div class='itemlist-item flex-parent'>
	<div class='flex-none'>
		<img src="$item->image_main" class="product-thumb">
	</div>
	...
	<div class='flex-none'>
		...
		<div>[<a href='sp.php?id=$item->id'>visit</a>]</div>
	</div>
</div>
HTML;
}
...
<form method="post" action="?id=$id&action=$createorupdate">
	...
	<div class="form-control">
		<label class="form-label" for="image_main">Thumbnail</label>
